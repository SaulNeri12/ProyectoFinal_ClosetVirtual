...
class ClothesSelectionFragment {
...
//            val navView = requireActivity().findViewById<BottomNavigationView>(R.id.bottom_nav_card)
//            val menuItem = navView.menu.findItem(R.id.navigation_new_clothes)
